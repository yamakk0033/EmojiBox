...
public class CreateFrame : MonoBehaviour {
    ...
    void Start () {
        ...
        this.CreateGameObject(new Vector3(0, + (screenVec3.y + 1f), 0), new Vector3(screenVec3.x * 2, 2, 1));
        this.CreateGameObject(new Vector3(0, - (screenVec3.y + 1f), 0), new Vector3(screenVec3.x * 2, 2, 1));

        this.CreateGameObject(new Vector3(+ (screenVec3.x + 1f), 0, 0), new Vector3(2, screenVec3.y * 2, 1));
        this.CreateGameObject(new Vector3(- (screenVec3.x + 1f), 0, 0), new Vector3(2, screenVec3.y * 2, 1));
    }
